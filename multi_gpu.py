...
parser.add_argument("--model_config_path", type=str, default="/dataset/PyTorch-YOLOv3/config/yolov3.cfg", help="path to model config file")
...
parser.add_argument("--class_path", type=str, default="/dataset/PyTorch-YOLOv3/data/coco.names", help="path to class label file")
...
parser.add_argument("--local_rank", type=int, help="current rank")
